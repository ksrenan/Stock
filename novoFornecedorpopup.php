...
include_once("fornecedor.class.php"); // Include da classe modelo
include_once("fornecedorDAO.php");

if(isset($_POST['razaoSocial']) && isset($_POST['cnpj'])){

	$fornecedor = new Fornecedor; // Instanciando um objeto do tipo Fornecedor
	
	$fornecedor->setRazaoSocial($_POST['razaoSocial']);
	$fornecedor->setCNPJ($_POST['cnpj']);
	$fornecedor->setIE($_POST['ie']);
	...
	$fornecedor->setNomeContato($_POST['contato']);
	$fornecedor->setEmailContato($_POST['email']);
...
?>
<form action="novoFornecedorpopup.php" method="post">
<table border="0" align="center" class="tabelaNovoUsuario">
  ...
  <tr>
	...
	<td colspan="2"><input type="submit" value="Salvar altera&ccedil;&otilde;es" class="botaoSalvar" />
    </td>
  </tr>
</table>
