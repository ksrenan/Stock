...
$stmt = $conexao_db->con->prepare("DELETE FROM itens WHERE codigo =?");
$stmt->bindParam(1,$codigo);
$stmt->execute();
echo "<br><br><br><center>Item com codigo ".$codigo." Removido com Sucesso<br>Redirecionando em 3 Segundos...";
